...
def main():
    ...
    train_dataset = train_dataset.shuffle(seed=args.seed).select(range(100))
    ...
    few_shot_examples = [train_dataset[shortest_solution_index], train_dataset[longest_solution_index]]
